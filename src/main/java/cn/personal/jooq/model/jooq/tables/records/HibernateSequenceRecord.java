...
public class HibernateSequenceRecord extends TableRecordImpl<HibernateSequenceRecord> implements
    Record1<Long> {

  private static final long serialVersionUID = 743369975;

  /**
   * Setter for <code>mydata.hibernate_sequence.next_val</code>.
   */
  ...
  /**
   * Getter for <code>mydata.hibernate_sequence.next_val</code>.
   */

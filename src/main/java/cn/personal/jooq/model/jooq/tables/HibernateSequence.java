...
import cn.personal.jooq.model.jooq.tables.records.HibernateSequenceRecord;
...
public class HibernateSequence extends TableImpl<HibernateSequenceRecord> {
  ...
  private static final long serialVersionUID = -1812581673;

  /**
   * The reference instance of <code>mydata.hibernate_sequence</code>
   */
  ...
  /**
   * The column <code>mydata.hibernate_sequence.next_val</code>.
   */
  public final TableField<HibernateSequenceRecord, Long> NEXT_VAL = createField("next_val",
      org.jooq.impl.SQLDataType.BIGINT, this, "");

  /**
   * Create a <code>mydata.hibernate_sequence</code> table reference
   */
  ...
  /**
   * Create an aliased <code>mydata.hibernate_sequence</code> table reference
   */
  ...
  public <O extends Record> HibernateSequence(Table<O> child,
      ForeignKey<O, HibernateSequenceRecord> key) {
